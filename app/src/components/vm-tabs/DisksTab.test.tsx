...
// The Storage domain column's id → name join (the real hook rides
// useStorageDomains → useSettings, unavailable under renderToStaticMarkup).
// One resolvable id so the join path itself is exercised.
vi.mock('../../hooks/useStorageDomainLookup', () => ({
  useStorageDomainLookup: () => (id?: string) =>
    id === 'sd-01' ? { id: 'sd-01', name: 'data-domain-01' } : undefined,
}))
