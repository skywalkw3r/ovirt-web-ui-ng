...
// disabled, so the panel's own skeletons cover that gap. The query key MUST be
// ['vmpool', id, 'permissions'] — the shared add/remove mutations invalidate
// [entityKind, entityId, 'permissions'] and this tab passes entityKind="vmpool",
// so any other key leaves the table stale until the next poll.
