...
export function VmsPage() {
  ...
  // Breadcrumb of the selected folder's ancestor chain; [] (a tag outside the
  // folder root — ids unknown to the tag list self-clear via
  // usePruneGhostFolder above) hides it — the empty state's "Clear folder
  // selection" is the honest escape hatch there.
  const folderPath =
